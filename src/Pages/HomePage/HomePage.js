  ...
  return (
    <>
      <div className="hero-wrapper">
        ...
        <AboutHero />
        <img
          className="about-us-hero-bg-image"
          src={aboutUsHeroBg}
          ref={ImgWrapperBg}
          alt="Background image"
        />
        <img
          className="about-us-hero-build-img-1"
          src={aboutUsHeroCircleImg1}
          ref={firstCircleImg}
          alt="Build-1"
        />
        <img
          className="about-us-hero-build-img-2"
          src={aboutUsHeroCircleImg2}
          ref={secondCircleImg}
          alt="Build-2"
        />
        <img
          className="about-us-hero-build-img-3"
          src={aboutUsHeroCircleImg3}
          ref={thirdCircleImg}
          alt="Build-3"
        />
      </div>
